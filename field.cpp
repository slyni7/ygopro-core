...
void field::ritual_release(card_set* material) {
	...
	send_to(&xyz, core.reason_effect->get_active_effect(), REASON_RITUAL + REASON_EFFECT + REASON_MATERIAL, core.reason_player, PLAYER_NONE, LOCATION_GRAVE, 0, POS_FACEUP);
